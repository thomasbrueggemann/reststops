...
const useLocation = async (options: GeoOptions, deps?: React.DependencyList | undefined) => {
	const hasLocationPermissionIOS = async () => {
		...
		if (status === "disabled") {
			Alert.alert(`Turn on Location Services to allow "${APP_NAME}" to determine your location.`, "", [
